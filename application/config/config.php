...
|
*/
$config['encryption_key'] = 'v34hUk5K8fD';
...
$config['sess_cookie_name'] = 'ci_projman_user';
...
$config['link_po_name_create'] = $config['base_url'].'po_name_create';
$config['link_po_name_edit'] = $config['base_url'].'po_name_edit';
...
$config['link_project_type'] = $config['base_url'].'project_type';
$config['link_project_type_create'] = $config['base_url'].'project_type_create';
$config['link_project_type_edit'] = $config['base_url'].'project_type_edit';
