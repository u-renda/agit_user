...
<div class="row" id="page_company_edit">
    <div class="col-md-12 col-sm-12">
        <form action="<?php echo $this->config->item('link_company_edit'); ?>" method="post" class="form-horizontal" id="form_company_edit" novalidate="novalidate">
            ...
            <div class="form-body">
                ...
                <div class="form-group form-md-line-input">
                    ...
                    <div class="col-md-9">
                        ...
                        <input type="text" class="form-control" name="name" id="name" value="<?php echo set_value('name'); echo $rows->name; ?>" />
