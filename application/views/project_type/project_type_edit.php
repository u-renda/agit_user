...
<div class="row" id="page_project_type_edit">
    <div class="col-md-12 col-sm-12">
        <form action="<?php echo $this->config->item('link_project_type_edit'); ?>" method="post" class="form-horizontal" id="form_project_type_edit" novalidate="novalidate">
...
$(document).ready(function () {
    var e=$("#form_project_type_edit"),
        r=$(".alert-danger", e),
        i=$(".alert-success", e),
        grid="grid_project_type";
