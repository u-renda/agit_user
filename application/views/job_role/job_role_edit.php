...
<div class="row" id="page_job_role_edit">
    <div class="col-md-12 col-sm-12">
        <form action="<?php echo $this->config->item('link_job_role_edit'); ?>" method="post" class="form-horizontal" id="form_job_role_edit" novalidate="novalidate">
