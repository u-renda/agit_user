...
<div class="row" id="page_position_edit">
    <div class="col-md-12 col-sm-12">
        <form action="<?php echo $this->config->item('link_position_edit'); ?>" method="post" class="form-horizontal" id="form_position_edit" novalidate="novalidate">
