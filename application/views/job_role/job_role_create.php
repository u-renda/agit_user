...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a href="<?php echo $this->config->item('link_job_role'); ?>">Job Role</a>
                <i class="fa fa-circle"></i>
            </li>
        ...
        <div class="row" id="page_job_role_create">
            <div class="col-md-12 col-sm-12">
                <div class="portlet light bordered">
                    <div class="portlet-body form">
                        <form action="<?php echo $this->config->item('link_job_role_create'); ?>" method="post" class="form-horizontal" id="form_job_role_create" novalidate="novalidate">
                            <div class="form-body">
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-9">
                                        ...
                                        <a type="button" class="btn default" href="<?php echo $this->config->item('link_job_role'); ?>">Cancel</a>
                                    </div>
                                </div>
                            </div>
                        </form>
