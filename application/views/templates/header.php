...
<html lang="en">
    ...
    <head>
        ...
        <link href="<?php echo base_url('assets/css/theme').'/simple-line-icons.min.css'; ?>" rel="stylesheet" type="text/css" />
        ...
        <link href="<?php echo base_url('assets/css/theme').'/pnotify.custom.css'; ?>" rel="stylesheet" type="text/css" />
        ...
        <link href="<?php echo base_url('assets/css/kendo'); ?>/kendo.bootstrap.min.css" rel="stylesheet">
        <!-- END KENDO STYLES -->
        <!-- BEGIN THEME LAYOUT STYLES -->
        <link href="<?php echo base_url('assets/css/theme').'/layout.min.css'; ?>" rel="stylesheet" type="text/css" />
    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo page-boxed page-footer-fixed">